...
public final class CactusFlowerCompatibilityLoader extends AbstractResourceLoader<List<String>> {
    private static final ResourceLocation PILLAR_CACTUS = new ResourceLocation("dynamictreesplus", "pillar_cactus");
    private static final ResourceLocation PIPE_CACTUS = new ResourceLocation("dynamictreesplus", "pipe_cactus");
    private static final ResourceLocation MEGA_CACTUS = new ResourceLocation("dynamictreesplus", "mega_cactus");
